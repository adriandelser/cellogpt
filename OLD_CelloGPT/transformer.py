...
class Head(nn.Module):
    ...
    def forward(self, x):
        ...
        # TODO dividing by C**0.5 so that statistics are preserved regardless of dimensionality?
        # NOTE no trilling, we can see the future notes BUG not quite how this works haha
        # need to discuss bidirectional decoders with someone who knows what they're talking about.
